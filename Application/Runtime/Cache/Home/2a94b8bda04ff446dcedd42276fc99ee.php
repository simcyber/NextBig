...
<header class="am-topbar am-topbar-fixed-top">
  <h1 class="am-topbar-brand">
    <a href="<?php echo U('Index/index');?>"><?php echo ($title); ?></a>
  </h1>
...
<div class="am-g">
	<div class="am-u-md-10 am-u-md-centered">
		<div class="am-g">
			<div class="am-u-md-8">
			<?php if($tag): ?><h1 style="font-size:5rem;"><?php echo ($tag); ?>-标签</h1><?php endif; ?>
			<br>
			<?php if(is_array($rs)): $i = 0; $__LIST__ = $rs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><article class="am-article">
				  <div class="am-article-hd">
					<h1 class="am-article-title"><?php echo ($vo["title"]); ?></h1>
					<p class="am-article-meta"><?php echo ($vo["nickname"]); ?> @<?php echo date('Y-m-d H:i',$vo['time']);?>					
					</p>
				  </div>

				  <div class="am-article-bd">
					<p>
					<a href="<?php echo U('Index/index',array('tag'=>urlencode($vo['tag'])));?>" class="am-icon-edit am-btn am-btn-secondary am-btn-xs"><?php echo ($vo["tag"]); ?></a>
					<?php echo ($vo["body"]); ?>
					</p>
					<?php if($_SESSION['uid']== $vo['uid'] ): ?><div class="am-fr">
					<a href="##" class="am-icon-edit am-btn am-btn-danger am-btn-xs">修改</a>
					</div><?php endif; ?>
				  </div>
				</article>
